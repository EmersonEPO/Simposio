    ...
    <body>
        ...
        <fieldset class="fieldsetRegistrar">
            ...
            <form id="formPessoa" name="formPessoa" method="POST" action="../controller/CtlPessoa.php">
                ...
                <input type="text" id="nome" name="nome" value="" required="" placeholder="João"  class="forRegistrar"/><br/>
                <label for="cpf" class="labelRegistrar">Cpf:</label>
                <input type="text" id="cpf" name="cpf" value="" required="" placeholder="111.111.111-11" class="forRegistrar" maxlength="11"/>
 
                <br/>
                <label for="nascimento" class="labelRegistrar">Data Nascimento:</label>
                <input type="text" id="nascimento" name="nascimento" value="" placeholder="00/00/0000" required="" class="forRegistrar"/>
                ...
                <input type="text" id="fone" name="fone" value="" placeholder="(00) 0000-0000" required="" class="forRegistrar"/><br/>
                ...
                <fieldset>
                    ...
                    <input type="text" id="rua" name="rua" value="" required="" placeholder="Rua" class="forRegistrar"/><br/>
                    <label for="rua" class="labelRegistrar">Numero:</label>
                    <input type="text" id="numero" name="numero" value="" required="" placeholder="0000" class="forRegistrar"/><br/>
                    <label for="rua" class="labelRegistrar">Bairro:</label>
                    <input type="text" id="bairro" name="bairro" value="" required="" placeholder="Bairro" class="forRegistrar"/><br/>
                ...
                <fieldset class="fieldsetRegistrarLog">
                    ...
                    <input type="text" id="email" name="email" value="<?php echo $email; ?>" required="" placeholder="Email" class="forRegistrarLog"/>
                  
                    <br/>
                    <label for="senha" class="labelRegistrar">Senha:</label>
                    <input type="password" id="primeiraSenha" name="primeiraSenha" placeholder="Senha" value="" required="" class="forRegistrarLog"/>
                    <br/>
                    <label for="confirmarSenha" class="labelRegistrar">Confirmar:</label>
                    <input type="password" id="senha" name="senha" value="" required="" class="forRegistrarLog" onblur="valida();" placeholder="Digite novamente"/>
                </fieldset>
